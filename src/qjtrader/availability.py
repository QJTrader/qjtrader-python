...
_AVAILABILITY: dict[str, Any] = {
    ...
    "observation_contract": {
        ...
        "provenance": "live messages carry meta.source, meta.venue, meta.sequence, agent_recv_ns, server_publish_ns, published_at, transport_age_ms, stale_reason and stale so consumers can detect an uplink backlog and compare sources without treating local receipt time as exchange time",
